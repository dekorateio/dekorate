...
public class Issue1009TcpSocketTest {
  ...
  public void shouldHaveOriginalPullPolicy() {
    ...
    assertNotNull(c);
    assertNull(c.getReadinessProbe().getTcpSocket().getHost());
    assertEquals(8080, c.getReadinessProbe().getTcpSocket().getPort().getIntVal());
