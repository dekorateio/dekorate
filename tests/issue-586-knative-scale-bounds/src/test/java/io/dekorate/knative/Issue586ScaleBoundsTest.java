...
public class Issue586ScaleBoundsTest {
  ...
  public void shouldContainMinAndMaxBounds() {
    ...
    String minScale = s.getSpec().getTemplate().getMetadata().getAnnotations().get("autoscaling.knative.dev/min-scale");
    String maxScale = s.getSpec().getTemplate().getMetadata().getAnnotations().get("autoscaling.knative.dev/max-scale");
