...
The integration test is [SpringBootOnOpenshiftIT.java](src/test/groovy/io/dekorate/example/sbonopenshift/SpringBootOnOpenshiftIT.java) and it demonstrates:
