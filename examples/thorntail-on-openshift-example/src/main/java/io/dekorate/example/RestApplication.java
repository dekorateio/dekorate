...
@OpenshiftApplication(livenessProbe = @Probe(httpActionPath = "/health", initialDelaySeconds = 180), readinessProbe = @Probe(httpActionPath = "/health", initialDelaySeconds = 20), route = @Route(expose = true))
