...
@Internal
public class OpenshiftExtesnsion implements ExecutionCondition, BeforeAllCallback, AfterAllCallback, WithPod, WithKubernetesClient, WithOpenshiftResources, WithProject, WithSourceToImageConfig {
