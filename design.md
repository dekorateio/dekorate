...
|-----------------------------------|----------------------|--------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|
| ComponentAnnotationProcessor      | CompositeConfig      | [io.dekorate.halkyon.annotation.ComponentApplication]                                                          | Generate component custom resources.                              |
| LinkAnnotationProcessor           | LinkConfig           | [io.dekorate.halkyon.annotation.Link]                                                                          | Generate link custom resources.                                   |
