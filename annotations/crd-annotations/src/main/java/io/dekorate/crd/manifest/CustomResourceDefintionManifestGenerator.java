...
public class CustomResourceDefintionManifestGenerator implements ManifestGenerator<CustomResourceConfig> {

  private final ResourceRegistry resources;

  public CustomResourceDefintionManifestGenerator(ResourceRegistry resources, ConfigurationRegistry configurationRegistry) {
