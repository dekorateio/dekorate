...
public class AddSecretToPipelineRunDecorator extends NamedResourceDecorator<PipelineRunSpecFluent<?>> {

  private final String workspace;
  private final String secret;

  public AddSecretToPipelineRunDecorator(String name, String workspace, String secret) {
    super(name);
